...
class SatisfaketionTest : DescribeSpec({
  ...
  describe("Fakes can be registered") {
    ...
    it("throws an exception when overriding a registered fake") {
      ...
      // assert
      result.message shouldStartWith "class io.github.unredundant.satisfaketion.core.util.SimpleDataClass"
    }
  ...
  describe("Fakes can be generated") {
    ...
    it("Throws an error when generate called on unregistered class") {
      ...
      // assert
      result.message shouldStartWith "No registered faker for class io.github.unredundant.satisfaketion.core.util.AnotherSimpleClass"
    }
  }
})
